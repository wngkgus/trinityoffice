...
document.querySelectorAll('.mobile-menu-btn').forEach(function(b){
  var header=b.closest('header'); var m=header&&header.querySelector('.mobile-menu-panel'); if(!m)return;
